...
@section('content')
                                    ...
                                    <div class="mb-3">
									   ...
									   <select name="deps_id" id="deps_id" class="form-control">
                                        <option value=""></option>
                                            ...
                                            <option value="{{ $departement->id }}" {{ $employer->deps_id === $departement->id ? 'selected' : '' }}>
                                            {{ $departement->name }}
                                             </option>
                                                @endforeach
                                       </select>
  ...
  <circle cx="8" cy="4.5" r="1"/>
									    ...
									    <input type="text" class="form-control" id="setting-input-1" placeholder="Entrez le nom de l'employé" name="nom" value="{{$employer->nom}}" required>
										@error('nom')
										<div class="text-danger">{{$message}}</div>
									@enderror
									</div>
									<div class="mb-3">
									    ...
									    <input type="text" class="form-control" id="setting-input-2" name="prenom" value="{{$employer->prenom}}" placeholder="Entrez le prénom"  required>
										@error('prenom')
										<div class="text-danger">{{$message}}</div>
									@enderror
									</div>
								    <div class="mb-3">
									    ...
									    <input type="email" class="form-control" id="setting-input-3" value="{{$employer->email}}" name="email"placeholder="Entrez le mail" required>
										@error('email')
										<div class="text-danger">{{$message}}</div>
									@enderror
									</div>
								    <div class="mb-3">
									    ...
									    <input type="text" class="form-control" id="setting-input-3" value="{{$employer->contact}}" name="contact"placeholder="Entrez le contact" required>
										@error('contact')
										<div class="text-danger">{{$message}}</div>
									@enderror
									</div>
								    <div class="mb-3">
									    ...
									    <input type="number" class="form-control" id="setting-input-3" min="0" name="montant_journalier" value="{{$employer->montant_journalier}}" placeholder="Entrez le montant journalier" required>
