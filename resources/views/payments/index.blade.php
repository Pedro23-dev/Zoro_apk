							        ...
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
                                            @forelse ($payments as $payment)
                                                ...
                                                <td>  {{ $payment->year }}</td>
                                                <td>
                                                    <button class="btn btn-success btn-sm">  {{ $payment->status }}</button></td>

												<td class="cell">

													<a class="btn-sm app-btn-secondary" href="{{route('payment.download', $payment->id)}}"> <i class="fa fa-download"></i></a>
												</td>
											</tr>
                                            @empty
                                            <tr>
