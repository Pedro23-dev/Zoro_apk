    ...
    <div class="box-container">
        ...
        <div class="transaction-box">
            ...
            <div class="item">
                ...
                <div class="value">{{ $fullPaymentInfo->employer->id }}</div>
            </div>
            <div class="item">
                ...
                <div class="value">
                    ...
                    ({{ $fullPaymentInfo->employer->email }})
                </div>
            </div>
            <div class="item">
                <div class="label">Département:</div>
                <div class="value">{{ $fullPaymentInfo->employer->deps->name }}</div>
            </div>
            <div class="item">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $fullPaymentInfo->amount }} Euro</td>
                            </tr>
                            <tr>
                                <td colspan="2">
